...
\usepackage{pmmeta}
\pmcanonicalname{GroupOfCoveringTransformations}
\pmcreated{2013-03-22 14:00:44}
\pmmodified{2013-03-22 14:00:44}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{group of covering transformations}
\pmrecord{6}{34906}
\pmprivacy{1}
\pmauthor{mathcam}{2727}
\pmtype{Definition}
\pmcomment{trigger rebuild}
\pmclassification{msc}{53Axx}
...
%% \include{argawarga}
\begin{document}
\section*{group of covering transformations}
\begin{123listcolonstyle} 
\item $(\{h:X\rightarrow X\pipe h \text{covering transformation}\}, \circ )$ 
