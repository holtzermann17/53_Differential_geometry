...
\usepackage{pmmeta}
\pmcanonicalname{Manifold}
\pmcreated{2013-03-22 12:20:22}
\pmmodified{2013-03-22 12:20:22}
\pmowner{matte}{1858}
...
\pmsynonym{differentiable manifold}{Manifold}
\pmsynonym{differential manifold}{Manifold}
\pmsynonym{smooth manifold}{Manifold}
\pmrelated{NotesOnTheClassicalDefinitionOfAManifold}
\pmrelated{LocallyEuclidean}
\pmrelated{3Manifolds}
\pmrelated{Surface}
\pmrelated{TopologicalManifold}
\pmrelated{ProofOfLagrangeMultiplierMethodOnManifolds}
\pmrelated{Submanifold}
\pmdefines{coordinate chart}
\pmdefines{chart}
\pmdefines{local coordinates}
\pmdefines{atlas}
\pmdefines{change of coordinates}
\pmdefines{differential structure}
\pmdefines{transition function}
\pmdefines{smooth structure}
\pmdefines{diffeomorphism}
\pmdefines{diffeomorphic}
\pmdefines{topological manifold}
\pmdefines{real-analytic manifold}
