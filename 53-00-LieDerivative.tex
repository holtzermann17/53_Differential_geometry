...
\usepackage{pmmeta}
\pmcanonicalname{LieDerivative}
\pmcreated{2013-03-22 13:14:10}
\pmmodified{2013-03-22 13:14:10}
\pmowner{rspuzio}{6075}
\pmmodifier{rspuzio}{6075}
\pmtitle{Lie derivative}
\pmrecord{6}{33707}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $M$ be a smooth manifold, $X$ a vector field on $M$, and $T$ a tensor on $M$.  Then the {\em Lie derivative}
$\mc{L}_XT$ of $T$ along $X$ is a tensor of the same rank as $T$ defined as 
$$\mc{L}_XT=\frac{d}{dt}\left(\rho^*_t(T)\right)|_{t=0}$$
