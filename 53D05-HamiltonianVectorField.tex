...
\usepackage{pmmeta}
\pmcanonicalname{HamiltonianVectorField}
\pmcreated{2013-03-22 13:14:07}
\pmmodified{2013-03-22 13:14:07}
\pmowner{rspuzio}{6075}
\pmmodifier{rspuzio}{6075}
\pmtitle{Hamiltonian vector field}
\pmrecord{7}{33706}
\pmprivacy{1}
...
and a symplectic vector field $X$ is \PMlinkid{Hamiltonian}{6410} if and only if the 1-form $\tom(X)=
\om(\cdot,X)$ is exact.
