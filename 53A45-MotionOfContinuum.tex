...
A.-L. Cauchy {\em M̩moire sur les dilatations, les condensations et les rotations produits par un changement de forme dans un syst\`eme de points materi̩ls,} Ex. d'An. Phys. Math. ${\bf 2}$ = {\em Oeuvres} (2) ${\bf 12,}$ 343-377, 1841. 
