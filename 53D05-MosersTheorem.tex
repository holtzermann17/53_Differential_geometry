...
\usepackage{pmmeta}
\pmcanonicalname{MosersTheorem}
\pmcreated{2013-03-22 13:18:08}
\pmmodified{2013-03-22 13:18:08}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Moser's theorem}
\pmrecord{6}{33806}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\omega_0$ and $\omega_1$ be symplectic structures on a compact manifold $M$.  If there is a path
in the space of symplectic structures of a fixed DeRham cohomology class connecting $\om_0$ and $\om_1$ (in particular $\om_0$ and $\om_1$ must have the same class), 
then $(M,\omega_0)$ and $(M,\omega_1)$ are symplectomorphic, by a symplectomorphism 
