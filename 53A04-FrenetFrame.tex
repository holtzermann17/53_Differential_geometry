...
\usepackage{pmmeta}
\pmcanonicalname{FrenetFrame}
\pmcreated{2013-03-22 12:15:44}
\pmmodified{2013-03-22 12:15:44}
\pmowner{rmilson}{146}
\pmmodifier{rmilson}{146}
\pmtitle{Frenet frame}
\pmrecord{16}{31660}
\pmprivacy{1}
...
\pmsynonym{moving trihedron}{FrenetFrame}
\pmsynonym{moving frame}{FrenetFrame}
\pmsynonym{rep\`ere mobile}{FrenetFrame}
\pmsynonym{Frenet trihedron}{FrenetFrame}
\pmrelated{SpaceCurve}
\pmdefines{osculating plane}
\pmdefines{normal plane}
\pmdefines{rectifying plane}
\pmdefines{unit normal}
\pmdefines{unit tangent}
\pmdefines{binormal}
