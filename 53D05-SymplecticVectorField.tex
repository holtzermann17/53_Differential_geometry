...
\usepackage{pmmeta}
\pmcanonicalname{SymplecticVectorField}
\pmcreated{2013-03-22 13:14:04}
\pmmodified{2013-03-22 13:14:04}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{symplectic vector field}
\pmrecord{4}{33705}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
If $(M,\om)$ is a symplectic manifold, then a vector field $X\in\fr{X}(M)$ is {\em symplectic} if
its flow preserves the symplectic structure.  That is, if the Lie derivative $\mc{L}_X\om=0$.
%%%%%
%%%%%
\end{document}
